...
class TwitterAPICaller: BDBOAuth1SessionManager {    
    static let client = TwitterAPICaller(baseURL: URL(string: "https://api.twitter.com"), consumerKey: "QEmPsWvIa8JCpRqngX162rgLs", consumerSecret: "z8Zl7u5YEA9Rdzw9J7LrYA15SGMGDudvHQN1M64pUNNweEWpgV")
    var loginSuccess: (() -> ())?
